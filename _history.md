...
[2026-02-11] [FEAT] 맵 104030001(버섯 정원) 추가: 주황버섯/스포어/빨간달팽이 스폰, 드롭 아이템 41종 일괄 생성. 맵/몬스터 한글명 번역 추가
[2026-02-11] [FEAT] 맵 100040001(던전: 남쪽 숲 1) 추가: fetch-map-all.ts로 슬라임 스폰 맵 추가, 몬스터 1종+드롭 아이템 20종 일괄 생성
[2026-02-11] [FEAT] 실시간 localStorage 자동저장: SaveData v0.2.0 파티 시스템, 30초 간격+이벤트(레벨업/맵이동/장비/생성) 즉시저장, 로드 시 idle 복원+lastMapId 사냥터 세팅, v0.1.0 마이그레이션 지원
